...
class _MemberGridState extends State<MemberGrid> {
  ...
  final List<String> _roles = ['Semua', 'Owner', 'Admin', 'Member Senior', 'Member'];
    ...
    return Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _filterSort == sort ? AppColors.primary : AppColors.card,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(color: _filterSort == sort ? AppColors.primary : AppColors.border),
                    ),
                    child: Text(
                      sort,
                      style: TextStyle(
                        ...
                        color: _filterSort == sort ? Colors.white : AppColors.textDim,
                      ),
                    ),
                  ),
                ),
              ...
              Container(width: 1, height: 20, color: AppColors.border, margin: const EdgeInsets.only(right: 8)),
              ...
              ..._roles.map((role) => Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
                    decoration: BoxDecoration(
                      color: _filterRole == role ? _getRoleColor(role) : AppColors.card,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: _filterRole == role ? _getRoleColor(role) : AppColors.border,
                      ),
                    ),
                    child: Text(
                      role,
                      style: TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.bold,
                        color: _filterRole == role ? Colors.white : AppColors.textDim,
                      ),
                    ),
                  ),
                ),
        ...
        Text(
          ...
          style: TextStyle(fontSize: 11, color: AppColors.textDim, fontWeight: FontWeight.bold),
        ),
        const SizedBox(height: 12),
        ...
        filtered.isEmpty
            ? Center(
                child: Padding(
                  ...
                  child: Text('Tidak ada anggota ditemukan.', style: TextStyle(color: AppColors.textDim)),
                ),
              )
            : GridView.builder(
                shrinkWrap: true,
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => MemberDetail(memberData: m),
                      ),
                    ),
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: photo.isNotEmpty
                                  ...
                                  : Container(
                                      ...
                                      child: const Icon(Icons.person, color: Colors.purple, size: 32),
                                    ),
                            ),
                          ),
                          const SizedBox(height: 12),
                          ...
                          Text(
                            ...
                            style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900, color: AppColors.textMain),
                          ),
                          ...
                          if (asal.isNotEmpty) ...[
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(Icons.location_on_outlined, size: 10, color: AppColors.textDim),
